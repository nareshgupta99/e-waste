...
import lockedCard from '../../resource/locked-card.png';
import './style1.css'
...
function DashboardUser() {
  return (
    ...
    <div class="app" style={{marginLeft:"2.5%"}}>
	...
	<div class="app-body">
		...
		<div class="app-body-main-content" style={{width: "50vw"}}>
			<section class="service-section">
				...
				<div class="tiles">
					<article class="tile" style={{backgroundColor: "transparent",padding: "0"}} >
						<img src={lockedCard} style={{height: "9.7rem", width: "11rem;"}} />
					</article>
					<article class="tile" style={{backgroundColor: "transparent",padding:" 0"}}>
						<img src={lockedCard} style={{height: "9.7rem", width: "11rem;"}} />
					</article>
				...
				<div class="service-section-footer">
					<p>Cards will be Unlocked after Succesfull Verification by Recycler.</p>
				</div>
			</section>
